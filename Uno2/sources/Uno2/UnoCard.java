...
public class UnoCard {
        ...
        public static final String[] COLORS = {"Yellow", "Blue", "Green", "Red", "Black"};
    ...
    public UnoCard(int color, int rank) {
        ...
        this.rank = rank; // 27 ranks (0 plus 2 of each other card including skip, reverse, drawTwo, wild, wildDraw4)
    }
...
*/    
    ...
    public String toString() {
        String s = COLORS[this.color] + " " + RANKS[this.rank];
        return s;
    }
...
/**
 * Problem is there are 2 of each card, so need to convert array index number to comparable value
 * so that, for example a yellow 5 where 5 is 1st 5 in Array index, matches second 5 that will have 
