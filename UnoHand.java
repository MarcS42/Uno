...
public class UnoHand{
    ...
    /**
     * Sorts unohand from smallest to largest.
     * Useful in strategy to play your best cards last as
     * once sorted ascending, it is easy to search from 
     * highest card to lowest. Idea is to keep best cards yet
     * minimize your score if you lose.
     * @param unohand
     * @return unohand sorted ascending
     */
...
//            System.out.println(UnoSpecialCardsV2.unoSpecialCard(unocard));
//        }
//        System.out.println();
//        deck.shuffle();
//
