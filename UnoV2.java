...
public class UnoV2 {
     ...
     * Initializes Player instances and ArrayList<Player>  
     *   objects
...
//     1st card cannot be wild so keeps dealing 1 card 
//        to discard pile until != wild
   ...
   public static int getWildColor() {
    ...
    public void displayState() {
        ...
        System.out.println("wildColor= " + wildColor+ " "
                + "Skip= " + skip + " firstPass = " + firstPass);
